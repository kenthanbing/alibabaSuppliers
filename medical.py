...
# 跳转到搜索结果页面
search_result_url = f'https://www.alibaba.com/trade/search?keyword=medical&country={section}&indexArea=company_en&page=1'
...
for i in range(1,last_page+1):
    ...
    search_result_url = f'https://www.alibaba.com/trade/search?keyword=medical&country={section}&indexArea=company_en&page={i}'
    driver.get(search_result_url)
    time.sleep(5)
